...
function draw() {
  ...
  translate(0, tra*height+spost);
    ...
    //   textAlign(CENTER);
    //   textSize(30);
    //   text(round(pos/-1000)+30+' kmq', width/2,height-100);
    // }
    // else {
    //   noStroke();
    //   fill(255);
    //   textAlign(CENTER);
    //   textSize(30);
    //   text('30 kmq',width/2,height-100);
    // }

  //   fill(255);
  //   textAlign(CENTER);
  //   text('Time is over', width/2,height/2+height);
  // pop();
...
// class Island {
//   constructor() {
//     this.y = random(height/2+120, height/2-60);
//     this.size = random(0.25,0.75);
//     this.z = random(0, 90);
//     this.img = arrImg[(round(random(0,31)))]
//   }
//   show(x, w) {
//       imageMode(CENTER);
//       push();
//       translate(x+w,this.y);
//       rotate(this.z);
//       scale(this.size);
//       image(this.img,0,0);
//       pop();
